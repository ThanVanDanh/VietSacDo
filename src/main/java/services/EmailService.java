...
public class EmailService {
    ...
    public void sendVerifyLink(String toEmail, String token, String domain) {
        ...
        try {
            ...
            // Nội dung HTML mô phỏng giao diện Google
            String htmlContent =
                    "<div style=\"font-family: Arial, sans-serif; border: 1px solid #dadce0; border-radius: 8px; padding: 40px; max-width: 550px; margin: 20px auto; text-align: center;\">" +
                            ...
                            "<a href=\"" + link + "\" style=\"display: inline-block; background-color: #1a73e8; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 4px; font-weight: 500; font-size: 14px;\">" +
                            "Kích hoạt tài khoản" +
                            "</a>" +
                            ...
                            "<a href=\"" + domain + "\" style=\"color: #1a73e8; text-decoration: none;\">Truy cập trang web của chúng tôi</a>" +
                            "</div>" +
                            "</div>";
