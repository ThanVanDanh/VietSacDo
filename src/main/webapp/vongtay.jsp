...
<div class="breadcrumb-container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="all-product.jsp">Sản Phẩm</a></li><li class="breadcrumb-item active" aria-current="page">Vòng tay</li>
        </ol>
    </nav>
</div>
<main>
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/vongtay1.jpg" alt="Vòng tay VO-116 Phụng Nghi vàng kem hoa mẫu đơn cam - 15mm"></a>
                    </div>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Vòng tay VO-116 Phụng Nghi vàng kem hoa mẫu đơn cam - 15mm</p></a>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/vongtay2.jpg" alt="Vòng tay VO-115 Phụng Nghi kem vàng vườn hoa cam - 15mm"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Vòng tay VO-115 Phụng Nghi kem vàng vườn hoa cam - 15mm</p></a>
                    <div class="product-price">
                        <span class="old-price">180,000₫</span>
                        <span class="current-price">153,000₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/vongtay3.jpg" alt="Vòng tay VO-114 Phụng Nghi vàng kem hoa đôi cam vàng - 10mm"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Vòng tay VO-114 Phụng Nghi vàng kem hoa đôi cam vàng - 10mm</p></a>
                    <div class="product-price">
                        <span class="old-price">180,000₫</span>
                        <span class="current-price">153,000₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/vongtay5.jpg" alt="Vòng tay VO-085 Phụng Nghi cam nhạt vân hoa trắng - 8mm"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Vòng tay VO-085 Phụng Nghi cam nhạt vân hoa trắng - 8mm</p></a>
                    <div class="product-price">
                        <span class="old-price">180,000₫</span>
                        <span class="current-price">153,000₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/vongtay6.jpg" alt="Vòng tay VO-091 Phụng Nghi kem hoa cam lớn - 10mm"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Vòng tay VO-091 Phụng Nghi kem hoa cam lớn - 10mm</p></a>
                    <div class="product-price">
                        <span class="old-price">180,000₫</span>
                        <span class="current-price">153,000₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/vongtay7.jpg" alt="Vòng tay VO-095 Phụng Nghi xanh cốm hoa đôi trắng - 10mm"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Vòng tay VO-095 Phụng Nghi xanh cốm hoa đôi trắng - 10mm</p></a>
                    <div class="product-price">
                        <span class="old-price">180,000₫</span>
                        <span class="current-price">153,000₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/vongtay8.jpg" alt="Vòng tay VO-063 hạt ngọc hoa xanh nhỏ"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Vòng tay VO-063 hạt ngọc hoa xanh nhỏ</p></a>
                    <div class="product-price">
                        <span class="old-price">120,000₫</span>
                        <span class="current-price">102,000₫</span>
                        <span class="discount-tag">15%</span>
                    </div>
                </div>
            </div>
    ...
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/manaodai6.png" alt="Mấn Bách Hoa Xuân Hai Sợi Phối Dây Hạt Ngọc"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Mấn Bách Hoa Xuân Hai Sợi Phối Dây Hạt Ngọc</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
                        <span class="discount-tag">15%</span>
