                            ...
                            <div class="mega-menu-content">
                                ...
                                <div class="category-column">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="hoatai.html">Hoa tai</a></li>
...
<div class="breadcrumb-container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="all-product.jsp">Sản Phẩm</a></li><li class="breadcrumb-item active" aria-current="page">Hoa tai</li>
        </ol>
    </nav>
</div>
<main>
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/hoatai1.jpg" alt="Hoa tai NK-192 hoa hồng nhạt 5 cánh phối dây cườm vàng trắng"></a>
                    </div>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Hoa tai NK-192 hoa hồng nhạt 5 cánh phối dây cườm vàng trắng</p></a>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/hoatai2.jpg" alt="Hoa tai NK-191 hoa trắng phối đá bầu dục hoa trong"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Hoa tai NK-191 hoa trắng phối đá bầu dục hoa trong</p></a>
                    <div class="product-price">
                        <span class="old-price">95,000₫</span>
                        <span class="current-price">80,750₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/hoatai3.jpg" alt="Hoa tai NK-190 hoa hồng phối đá bầu dục hoa trong"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Hoa tai NK-190 hoa hồng phối đá bầu dục hoa trong</p></a>
                    <div class="product-price">
                        <span class="old-price">95,000₫</span>
                        <span class="current-price">80,750₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/hoatai4.jpg" alt="Hoa tai NK-189 hoa đá trắng phối xanh ngọc"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Hoa tai NK-189 hoa đá trắng phối xanh ngọc</p></a>
                    <div class="product-price">
                        <span class="old-price">95,000₫</span>
                        <span class="current-price">80,750₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/hoatai6.jpg" alt="Hoa tai NK-184 hoa tím đính đá phối giọt nước rũ"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Hoa tai NK-184 hoa tím đính đá phối giọt nước rũ</p></a>
                    <div class="product-price">
                        <span class="old-price">95,000₫</span>
                        <span class="current-price">80,750₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/hoatai7.jpg" alt="Hoa tai NK-183 hoa hồng đính đá phối giọt nước rũ"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Hoa tai NK-183 hoa hồng đính đá phối giọt nước rũ</p></a>
                    <div class="product-price">
                        <span class="old-price">95,000₫</span>
                        <span class="current-price">80,750₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/hoatai8.jpg" alt="Hoa tai NK-180 hoa cườm hồng nhạt trắng phối lá xanh nhụy vàng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Hoa tai NK-180 hoa cườm hồng nhạt trắng phối lá xanh nhụy vàng</p></a>
                    <div class="product-price">
                        <span class="old-price">95,000₫</span>
                        <span class="current-price">80,750₫</span>
                        <span class="discount-tag">15%</span>
