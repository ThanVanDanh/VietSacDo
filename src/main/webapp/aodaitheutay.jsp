            ...
            <ul class="menu">
                ...
                <li><a href="#">Áo dài<i class="fa-solid fa-chevron-down"></i></a>
                    <ul class="sub-menu">
                        ...
                        <li><a href="aodaitheutay.html">Áo dài thêu tay</a></li>
...
<div class="breadcrumb-container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="all-product.jsp">Sản Phẩm</a></li><li class="breadcrumb-item active" aria-current="page">Áo dài thêu tay</li>
        </ol>
    </nav>
</div>
<main>
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt01.png" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Bách Hoa - thêu tay Hương Lài Đỏ</p></a>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt02.png" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                        </a>
                        <a href="l" class="icon-button" title="Xem nhanh">
                            <i class="fa-solid fa-eye"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Bách Hoa Thêu tay Hương Lài - Hồng đào</p></a>
                    <div class="product-price">
                        <span class="old-price">790,000₫</span>
                        <span class="current-price">671,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt03.png" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Bách Hoa Thêu tay Hương Lài - Hồng dâu</p></a>
                    <div class="product-price">
                        <span class="old-price">790,000₫</span>
                        <span class="current-price">671,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt04.png" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Bách Hoa Thêu tay Hương Lài - Kem nhạt</p></a>
                    <div class="product-price">
                        <span class="old-price">790,000₫</span>
                        <span class="current-price">671,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt05.png" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Bách Hoa Thêu tay Hương Lài - Tím nhạt</p></a>
                    <div class="product-price">
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt06.png" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Bách Hoa Thêu tay Hương Lài - Xanh biển nhạt</p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt07.png" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Bách Hoa Thêu tay Hương Lài - Xanh ngọc</p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt08.jpg" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Hương Lài - Đỏ đô</p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt09.png" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Hương Lài - Đỏ tươin</p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt10.png" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Hương Lài - Hồng</p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt11.jpeg" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Hương Lài </p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt12.jpeg" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Hương Lài - Xanh ngọc</p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt13.jpeg" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Linh Lan - Cam</p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt14.jpeg" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Linh Lan - Xanh lam</p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt15.jpeg" alt="Áo dài linen Chi Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Mùa Vui - Cam sữa</p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt16.jpeg" alt="Áo dài linen hoa Ý Lan"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt17.jpeg" alt="Áo dài linen hoa Ý Mai"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài linen hoa Ý Mai Áo dài Dáng xưa Thêu tay Mùa Vui - Đỏ</p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt18.jpeg" alt="Áo dài linen hoa Ý Nhi"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Mùa Vui - Đỏ </p></a>
                    <div class="product-price">
                        <span class="current-price">790,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt19.jpeg" alt="Áo dài linen hoa Ý Nhiên"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Mùa Vui - Hồng đậm </p></a>
                    <div class="product-price">
                        <span class="current-price">720,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt20.jpeg" alt="Áo dài linen hoa Ý Xuân"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt21.jpeg" alt="Áo dài linen Khả Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài Dáng xưa Thêu tay Mùa Vui - Xanh ngọc nhạt</p></a>
                    <div class="product-price">
                        <span class="old-price">790,000₫</span>
                        <span class="current-price">671,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/adtt22.png" alt="Áo dài linen Mộc Lan cổ đứng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Áo dài linen Thêu tay An Điệp</p></a>
                    <div class="product-price">
                        <span class="old-price">790,000₫</span>
                        <span class="current-price">671,500₫</span>
                        <span class="discount-tag">15%</span>
