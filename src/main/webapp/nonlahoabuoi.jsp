                            ...
                            <div class="mega-menu-content">
                                ...
                                <div class="category-column">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="nonlahoabuoi.html">Nón lá bọc vải Chè hoa bưởi</a></li>
                                    </ul>
                                </div>
...
<div class="breadcrumb-container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="all-product.jsp">Sản Phẩm</a></li><li class="breadcrumb-item active" aria-current="page">Nón lá Hoa Bưởi</li>
        </ol>
    </nav>
</div>
<main>
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/nonla_hoabuoi1.png" alt="Nón lá bọc vải Chè hoa bưởi - Gấm hồng hồ điệp"></a>
                    </div>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Nón lá bọc vải Chè hoa bưởi - Gấm hồng hồ điệp</p></a>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/nonla_hoabuoi4.png" alt="Nón lá bọc vải Chè hoa bưởi - Gấm hồng phấn"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tuỳ chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Nón lá bọc vải Chè hoa bưởi - Gấm hồng phấn</p></a>
                    <div class="product-price">
                        <span class="current-price">190,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/nonla_hoabuoi5.jpg" alt="Nón lá bọc vải Chè hoa bưởi - Gấm hồng phấn"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tuỳ chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/nonla_hoabuoi6.png" alt="Nón lá bọc vải Chè hoa bưởi - Gấm hồng sáng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tuỳ chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Nón lá bọc vải Chè hoa bưởi - Gấm hồng sáng</p></a>
                    <div class="product-price">
                        <span class="current-price">190,000₫</span>
                    </div>
                </div>
