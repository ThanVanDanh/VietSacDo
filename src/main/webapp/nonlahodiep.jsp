                        ...
                        <div class="mega-menu-container">
                            <div class="mega-menu-content">
                                ...
                                <div class="category-column">
                                    <h3>Nón Lá</h3>
                                    <ul>
                                        <li><a href="nonlahodiep.html">Nón lá bọc vải Hồ điệp</a></li>
...
<div class="breadcrumb-container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="all-product.jsp">Sản Phẩm</a></li><li class="breadcrumb-item active" aria-current="page">Nón lá Hồ Điệp</li>
        </ol>
    </nav>
</div>
<main>
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/nonla_hodiep1.png" alt="Nón lá bọc vải Hồ điệp - Cam ngọt"></a>
                    </div>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Nón lá bọc vải Hồ điệp - Cam ngọt</p></a>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/nonlahodiep2.jpg" alt="Nón lá bọc vải Hồ điệp - Hồng nhạt"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tuỳ chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Nón lá bọc vải Hồ điệp - Hồng nhạt</p></a>
                    <div class="product-price">
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/nonlahodiep3.jpg" alt="Nón lá bọc vải Hồ điệp - Hồng sáng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tuỳ chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Nón lá bọc vải Hồ điệp - Hồng sáng</p></a>
                    <div class="product-price">
                        <span class="current-price">190,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/nonlahodiep4.jpg" alt="Nón lá bọc vải Hồ điệp - Hồng sen"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tuỳ chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Nón lá bọc vải Hồ điệp - Hồng sen</p></a>
                    <div class="product-price">
                        <span class="current-price">190,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/nonlahodiep5.png" alt="Nón lá bọc vải Hồ điệp - Tím ánh xanh"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tuỳ chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Nón lá bọc vải Hồ điệp - Tím ánh xanh</p></a>
                    <div class="product-price">
                        <span class="current-price">120,000₫</span>
                    </div>
                </div>
