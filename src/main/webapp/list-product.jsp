                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-price">
                            <c:choose>
                                <%-- CÓ GIẢM GIÁ --%>
                                <c:when test="${pdto.discountedPrice > 0 && pdto.discountedPrice < pdto.price}">
                                    <div class="current-price">
                                        <fmt:formatNumber value="${pdto.discountedPrice}" pattern="#,###"/>₫
                                    </div>
                                    ...
                                    <div class="price-meta">
                                        ...
                                        <c:set var="percent" value="${Math.round((1 - pdto.discountedPrice/pdto.price) * 100)}" />
