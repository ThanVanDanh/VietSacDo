                            ...
                            <div class="mega-menu-content">
                                ...
                                <div class="category-column">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="daychuyen.html">Dây chuyền</a></li>
...
<div class="breadcrumb-container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="all-product.jsp">Sản Phẩm</a></li><li class="breadcrumb-item active" aria-current="page">Dây chuyền</li>
        </ol>
    </nav>
</div>
<main>
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/daychuyen1.jpg" alt="Dây chuyền NT-006 hạt ngọc mặt giọt nước xanh lá lấp lánh"></a>
                    </div>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Dây chuyền NT-006 hạt ngọc mặt giọt nước xanh lá lấp lánh</p></a>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/daychuyen2.jpg" alt="Dây chuyền NT-005 hạt ngọc mặt giọt nước trắng lấp lánh"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Dây chuyền NT-005 hạt ngọc mặt giọt nước trắng lấp lánh</p></a>
                    <div class="product-price">
                        <span class="current-price">153,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/daychuyen3.jpg" alt="Dây chuyền NT-004 hạt trắng mặt nơ trắng đính đá - size 1"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Dây chuyền NT-004 hạt trắng mặt nơ trắng đính đá - size 1</p></a>
                    <div class="product-price">
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/daychuyen4.jpg" alt="Dây chuyền NT-003 ngọc đôi mặt hạt ngọc giọt nước"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Dây chuyền NT-003 ngọc đôi mặt hạt ngọc giọt nước</p></a>
                    <div class="product-price">
                        <span class="current-price">153,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/daychuyen5.jpg" alt="Dây chuyền hạt trắng - Size 4"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Dây chuyền hạt trắng - Size 4</p></a>
                    <div class="product-price">
                        <span class="current-price">102,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/daychuyen6.jpg" alt="Dây chuyền mặt bươm bướm xanh phối hạt"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Dây chuyền mặt bươm bướm xanh phối hạt</p></a>
                    <div class="product-price">
                        <span class="current-price">102,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/daychuyen7.jpg" alt="Dây chuyền mặt hoa cúc lá xanh"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Dây chuyền mặt hoa cúc lá xanh</p></a>
                    <div class="product-price">
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/daychuyen8.png" alt="Dây chuyền ngọc đôi"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Dây chuyền ngọc đôi</p></a>
                    <div class="product-price">
                        <span class="current-price">144,500₫</span>
                    </div>
                </div>
            </div>
        </div>
