                            ...
                            <div class="mega-menu-content">
                                ...
                                <div class="category-column">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="guocgo.html">Guốc gỗ</a></li>
...
<div class="breadcrumb-container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="all-product.jsp">Sản Phẩm</a></li><li class="breadcrumb-item active" aria-current="page">Guốc gỗ</li>
        </ol>
    </nav>
</div>
<main>
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/guocgo1.jpg" alt="Guốc gỗ Đế cao bọc vải Phụng Lan - Đỏ"></a>
                    </div>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Guốc gỗ Đế cao bọc vải Phụng Lan - Đỏ</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/guocgo2.jpg" alt="Guốc gỗ Đế cao bọc vải Phụng Lan - Đen"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Guốc gỗ Đế cao bọc vải Phụng Lan - Đen</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/guocgo3.png" alt="Guốc gỗ Đế cao bọc vải Phụng Lan - Vàng kem"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Guốc gỗ Đế cao bọc vải Phụng Lan - Vàng kem</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/guocgo4.png" alt="Guốc gỗ Đế cao bọc vải Phụng Lan - Quai trong"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Guốc gỗ Đế cao bọc vải Phụng Lan - Quai trong</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/guocgo5.png" alt="Guốc gỗ Đế cao quai nhung kim sa Phụng Sa - Trắng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Guốc gỗ Đế cao quai nhung kim sa Phụng Sa - Trắng</p></a>
                    <div class="product-price">
                        <span class="old-price">350,000₫</span>
                        <span class="current-price">297,500₫</span>
                        <span class="discount-tag">15%</span>
                    </div>
                </div>
            </div>
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/guocgo6.png" alt="Guốc gỗ Đế cao quai nhung kim sa Phụng Sa - Đỏ"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Guốc gỗ Đế cao quai nhung kim sa Phụng Sa - Đỏ</p></a>
                    <div class="product-price">
                        <span class="old-price">350,000₫</span>
                        <span class="current-price">297,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/guocgo7.png" alt="Guốc gỗ Đế cao quai nhung kim sa Phụng Sa - Hồng đậm"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Guốc gỗ Đế cao quai nhung kim sa Phụng Sa - Hồng đậm</p></a>
                    <div class="product-price">
                        <span class="old-price">350,000₫</span>
                        <span class="current-price">297,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/guocgo8.png" alt="Guốc gỗ Đế cao quai nhung kim sa Phụng Sa - Đen"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Guốc gỗ Đế cao quai nhung kim sa Phụng Sa - Đen</p></a>
                    <div class="product-price">
                        <span class="old-price">350,000₫</span>
                        <span class="current-price">297,500₫</span>
                        <span class="discount-tag">15%</span>
    ...
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/hoatai5.jpg" alt="Hoa tai NK-185 hoa hồng phối trái mâm xôi rũ"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Hoa tai NK-185 hoa hồng phối trái mâm xôi rũ</p></a>
                    <div class="product-price">
                        <span class="old-price">95,000₫</span>
                        <span class="current-price">80,750₫</span>
                        <span class="discount-tag">15%</span>
                    </div>
                </div>
            </div>
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/vongtay4.jpg" alt="Vòng tay VO-092 Phụng Nghi đỏ hoa xanh trắng vân vàng - 10mm"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Vòng tay VO-092 Phụng Nghi đỏ hoa xanh trắng vân vàng - 10mm</p></a>
                    <div class="product-price">
                        <span class="old-price">180,000₫</span>
                        <span class="current-price">153,000₫</span>
                        <span class="discount-tag">15%</span>
                    </div>
                </div>
            </div>
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/manaodai7.png" alt="Mấn Trơn Hai Sợi Phối Dây Hạt Ngọc (Hạt to)"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Mấn Trơn Hai Sợi Phối Dây Hạt Ngọc (Hạt to)</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
                        <span class="discount-tag">15%</span>
        ...
        <div class="footer-content">
            ...
            <div class="footer-column links">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="aodailinen.jsp">Áo dài linen</a></li>
                    <li><a href="quantrucchi.jsp">Quần trúc chi</a></li>
                    <li><a href="guocgo.html">Guốc mộc</a></li>
                    <li><a href="contactus.jsp">Liên hệ</a></li>
                </ul>
            </div>
