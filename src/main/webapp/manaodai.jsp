                        ...
                        <div class="mega-menu-container">
                            <div class="mega-menu-content">
                                ...
                                <div class="category-column">
                                    <h3>Phụ kiện</h3>
                                    <ul>
                                        <li><a href="manaodai.html">Mấn áo dài</a></li>
...
<div class="breadcrumb-container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="all-product.jsp">Sản Phẩm</a></li><li class="breadcrumb-item active" aria-current="page">Mấn áo dài</li>
        </ol>
    </nav>
</div>
<main>
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/manaodai4.png" alt="Mấn Yên Xuân Hai Sợi Phối Dây Hạt Ngọc - Hồng pastel"></a>
                    </div>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Mấn Yên Xuân Hai Sợi Phối Dây Hạt Ngọc - Hồng pastel</p></a>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/manaodai5.png" alt="Mấn Yên Xuân Hai Sợi Phối Dây Hạt Ngọc - Xanh cổ vịt"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Mấn Yên Xuân Hai Sợi Phối Dây Hạt Ngọc - Xanh cổ vịt</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/manaodai8.png" alt="Mấn Yên Xuân Hai Sợi Phối Dây Hạt Ngọc - Xanh lá mạ"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Mấn Yên Xuân Hai Sợi Phối Dây Hạt Ngọc - Xanh lá mạ</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/manaodai.png" alt="Mấn Pháp Lam - Vàng"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Mấn Pháp Lam - Vàng</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/manaodai2.png" alt="Mấn Pháp Lam - Xanh"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Mấn Pháp Lam - Xanh</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
                        <span class="discount-tag">15%</span>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/manaodai3.png" alt="Mấn Pháp Lam - Tím"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Mấn Pháp Lam - Tím</p></a>
                    <div class="product-price">
                        <span class="old-price">250,000₫</span>
                        <span class="current-price">212,500₫</span>
                        <span class="discount-tag">15%</span>
