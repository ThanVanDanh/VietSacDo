                ...
                <div class="product-container">
                    ...
                    <div class="product-details">
                        ...
                        <div class="product-price">
                            ...
                            <p class="saving">(<span class="save">Tiết kiệm</span> <span class="price">118.500₫</span>)
                            </p>
                        </div>
                        ...
                        <div class="size-options">
                            <c:forEach items="${p.variants}" var="variant" varStatus="status">
                                <button class="size-btn ${status.first ? 'active' : ''}"
                                    data-price="${variant.currentPrice}" data-sku="${variant.sku}"
                                    data-color="${variant.color}" data-stock="${variant.stockQuantity}"
