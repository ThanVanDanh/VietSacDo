                            ...
                            <div class="mega-menu-content">
                                ...
                                <div class="category-column">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="quanmaichi.html">Quần Mai Chi</a></li>
...
<div class="breadcrumb-container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="all-product.jsp">Sản Phẩm</a></li><li class="breadcrumb-item active" aria-current="page">Quần Mai Chi</li>
        </ol>
    </nav>
</div>
<main>
    <section class="product-showcase tab-component">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/quanmaichi1.jpg" alt="Quần Mai Chi - Cam cháy"></a>
                    </div>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Quần Mai Chi - Cam cháy</p></a>
                    <div class="product-price">
                        <span class="current-price">410,000₫</span>
                    </div>
                </div>
            </div>
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/quanmaichi2.jpeg" alt="Quần Mai Chi - Cam đào"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Quần Mai Chi - Cam đào</p></a>
                    <div class="product-price">
                        <span class="current-price">410,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/quanmaichi3.jpg" alt="Quần Mai Chi - Cam pastel"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Quần Mai Chi - Cam pastel</p></a>
                    <div class="product-price">
                        <span class="current-price">410,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/quanmaichi4.jpg" alt="Quần Mai Chi - Đen ánh xanh"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Quần Mai Chi - Đen ánh xanh</p></a>
                    <div class="product-price">
                        <span class="current-price">410,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/quanmaichi5.jpeg" alt="Quần Mai Chi - Đỏ"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Quần Mai Chi - Đỏ</p></a>
                    <div class="product-price">
                        <span class="current-price">410,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/quanmaichi6.jpg" alt="Quần Mai Chi - Hồng đất"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Quần Mai Chi - Hồng đất</p></a>
                    <div class="product-price">
                        <span class="current-price">410,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/quanmaichi7.jpg" alt="Quần Mai Chi - Hồng pastel"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Quần Mai Chi - Hồng pastel</p></a>
                    <div class="product-price">
                        <span class="current-price">410,000₫</span>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-image-wrapper">
                    <div class="product-image">
                        <a href="product-information.jsp"><img src="image/quanmaichi8.png" alt="Quần Mai Chi - Hồng tím"></a>
                    </div>
                    <div class="product-overlay">
                        <a href="product-information.jsp" class="icon-button" title="Tùy chọn">
                            <i class="fa-solid fa-cart-shopping"></i>
                ...
                <div class="product-info">
                    <a href="product-information.jsp"><p class="product-name">Quần Mai Chi - Hồng tím</p></a>
                    <div class="product-price">
                        <span class="current-price">410,000₫</span>
                    </div>
                </div>
